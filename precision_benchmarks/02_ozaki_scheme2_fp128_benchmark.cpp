...
int main() {
    ...
    for (size_t N : sizes) {
        ...
        for (double phi : phis) {
            ...
            for (int slices : test_slices) {
                std::cout << "Scheme II," << N << "," << std::fixed << std::setprecision(1) << phi << "," << slices << ","
    ...
    // =========================================================================
    std::cout << "\n\n========================================================================\n";
    std::cout << " SUMMARY REPORT: SCHEME II PRECISION CROSSOVER POINTS\n";
    std::cout << "========================================================================\n";
